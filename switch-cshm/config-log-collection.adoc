...
CAUTION: Wenn von der Protokollerfassungsfunktion Fehlerstatus gemeldet werden (sichtbar in der Ausgabe von `system switch ethernet log show` ), sehenlink:log-collection-troubleshoot.html["Fehlerbehebung bei der Protokollerfassung"] für weitere Einzelheiten.
