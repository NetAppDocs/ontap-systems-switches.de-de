...
Nach dem Zurücksetzen des Schalters können Sie link:configure-software-overview-3232c-storage.html["neu konfigurieren"] ihn entsprechend Ihren Anforderungen konfigurieren.
