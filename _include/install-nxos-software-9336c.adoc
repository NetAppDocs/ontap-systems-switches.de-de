...
* Entsprechende Leitfäden für Software und Upgrades auf der Cisco Website für die Upgrade- und Downgrade-Verfahren von Cisco Switches. Siehe https://["Switches Der Cisco Nexus 9000-Serie"^].
