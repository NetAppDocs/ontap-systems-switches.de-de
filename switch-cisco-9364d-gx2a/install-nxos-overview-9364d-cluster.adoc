...
summary: Bereiten Sie die Installation der NX-OS-Software und von RCF vor. 
---
...
.Wie geht es weiter?
Nachdem Sie die Installation der NX-OS-Software und von RCF vorbereitet haben, link:install-nxos-software-9364d-cluster.html["Installieren oder aktualisieren Sie die NX-OS-Software"]Die
