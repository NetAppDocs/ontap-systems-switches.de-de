...
summary: 'Der Austausch eines defekten Nexus 9364D-GX2A Switches in einem Clusternetzwerk ist ein unterbrechungsfreies Verfahren (NDU).' 
---
...
** Die erste Anpassung des Schalters ist abgeschlossen, wie in folgendem Abschnitt detailliert beschrieben:link:setup-switch-9364d-cluster.html["Konfigurieren des Cluster-Switches 9364D-GX2A"] Die
+
...
----
====
. Schalten Sie alle Ports am newcs2-Switch ein.
+
.Beispiel anzeigen
[%collapsible]
====
