...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["Drei"]link:smart-call-9364d-cluster.html["Überprüfen Sie die Smart Call Home-Anforderungen"]
[role="quick-margin-para"]
