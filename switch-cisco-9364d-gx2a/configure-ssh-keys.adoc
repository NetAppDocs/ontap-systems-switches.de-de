...
summary: SSH ist für die Nutzung der Funktionen „Cluster Switch Health Monitor“ und „Log-Erfassung“ erforderlich. Um SSH auf Cisco 9364d-gx2a Cluster-Switches zu aktivieren, müssen Sie zunächst die SSH-Schlüssel generieren und anschließend SSH aktivieren. 
---
