...
.. Für NX-OS 10.2 und neuer verwenden Sie die `show diff running-config` Befehl zum Vergleich mit der gespeicherten RCF-Datei im Bootflash. Verwenden Sie andernfalls ein Vergleichstool eines Drittanbieters.
