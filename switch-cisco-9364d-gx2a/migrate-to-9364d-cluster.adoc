...
summary: Sie können ältere Cisco -Cluster-Switches für einen ONTAP Cluster unterbrechungsfrei auf Cisco Nexus 9364d-gx2a-Cluster-Netzwerk-Switches migrieren. 
---
= Migrieren Sie von einem älteren Cisco -Switch zu einem Cisco Nexus 9364D-GX2A-Switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können eine unterbrechungsfreie Migration von einem älteren Cisco -Cluster-Switch zu einem Cisco Nexus 9364D-GX2A-Cluster-Netzwerk-Switch durchführen.
