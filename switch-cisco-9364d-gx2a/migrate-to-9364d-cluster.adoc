...
--
====
. [[step5]]Wenn Sie die automatische Fallerstellung unterdrückt haben, aktivieren Sie sie wieder, indem Sie eine AutoSupport Nachricht aufrufen: `system node autosupport invoke -node * -type all -message MAINT=END`
