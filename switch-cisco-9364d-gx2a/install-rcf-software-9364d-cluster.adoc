...
summary: Sie können das RCF installieren, nachdem Sie den Nexus 9364d-gx2a-Switch zum ersten Mal eingerichtet haben. 
---
...
[role="lead"]
Sie installieren die RCF, nachdem Sie den Nexus 9364D-GX2A Switch zum ersten Mal eingerichtet haben.
...
.Wie geht es weiter?
Nach der Installation des RCF, link:configure-ssh-keys.html["Überprüfen Sie die SSH-Konfiguration"]Die
