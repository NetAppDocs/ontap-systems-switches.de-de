...
* Der erste Cluster Port ist auf C1 verschoben (,Schritt 1- ,20)
* Der zweite Cluster-Port wurde auf C2 ( verschoben,Schritt 21- ,32).
* Deaktivieren Sie die 2-Node-Cluster-Option (,Schritt 33- ,35)
