...
|===
.Verfügbare RCFs
Die folgende Tabelle listet die verfügbaren RCFs für 3132Q-V-Schalter auf.  Wählen Sie die für Ihre Konfiguration passende RCF-Version aus. Sehenlink:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco Ethernet-Switches"^] für weitere Informationen.
...
Einzelheiten zu den verfügbaren RCF-Konfigurationen finden Sie unterlink:configure-software-overview-3132q-v-cluster.html["Softwareinstallations-Workflow"] .
