...
summary: SSH ist für die Nutzung der Funktionen „Cluster Switch Health Monitor“ und „Log-Erfassung“ erforderlich. Um SSH auf Cisco 3132q-v Cluster Switches zu aktivieren, generieren Sie zuerst die SSH-Schlüssel und aktivieren dann SSH. 
---
