...
NOTE: Wie Sie Ihre 10-GbE-Ports nach einem Upgrade des RCF online schalten können, erfahren Sie in dem Knowledge Base Artikel https://kb.netapp.com/onprem%2FSwitches%2FCisco%2F10GbE_ports_on_Cisco_3132Q_cluster_switch_do_not_come_online["10-GbE-Ports auf einem Cisco 3132Q Cluster-Switch werden nicht online geschaltet"^].
...
----
====
. Wenden Sie dieselbe RCF an, und speichern Sie die ausgeführte Konfiguration ein zweites Mal. Dies ist notwendig, da der RCF QoS verwendet und eine TCAM-Neukonfiguration erfordert, bei der der RCF zweimal geladen wird, während der Switch dazwischen neu gestartet wird.
+
.Beispiel anzeigen
[%collapsible]
====
