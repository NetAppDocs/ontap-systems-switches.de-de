...
.Wie geht es weiter?
Nachdem Sie die Migrationsanforderungen geprüft haben, können Sielink:migrate-switchless-prepare-to-migrate.html["Bereiten Sie sich auf die Migration Ihrer Schalter vor."] Die
