...
[role="lead"]
Mithilfe dieses Verfahrens können Sie die NX-OS-Software auf dem Nexus 3132Q-V Cluster Switch installieren.
...
+
Dieses Beispiel zeigt, dass SFTP zum Kopieren der NX-OS-Software auf den Nexus 3132Q-V-Switch verwendet wird:
