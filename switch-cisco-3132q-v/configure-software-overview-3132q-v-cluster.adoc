...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Vier"]link:install-upgrade-rcf-overview-3132q-v.html["Installieren oder aktualisieren Sie die RCF"]
[role="quick-margin-para"]
