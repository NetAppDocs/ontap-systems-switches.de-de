...
---
= Installieren Sie einen Cisco Nexus 3132Q-V Cluster Switch und eine Pass-Through-Panel in einem NetApp Rack
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können den Cisco Nexus 3132Q-V Switch und die Pass-Through-Panel in einem NetApp Rack mit den im Lieferumfang des Switches enthaltenen Standardhalterungen installieren.
...
http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus3000/hw/installation/guide/b_n3000_hardware_install_guide.html["Hardware-Installationsleitfaden Der Cisco Nexus 3000-Serie"^]
