...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["Drei"]link:smart-call-home-3132q.html["Anforderungen für Smart Call Home"]
[role="quick-margin-para"]
