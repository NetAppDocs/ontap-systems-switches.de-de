...
* Nexus 3132Q-V: Anschlüsse e1/1-30 (10/40/100 GbE)
...
Derlink:https://hwu.netapp.com/["_Hardware-Universum_"^] enthält Informationen zur unterstützten Verkabelung von Nexus 3132Q-V Switches:
...
* Bei Nexus 3132Q-V Switches können Sie QSFP/QSFP28 Ports entweder im 40/100 Gigabit Ethernet-Modus oder im 4 x10 Gigabit Ethernet-Modus betreiben.
+
...
* Auf der linken Seite der Nexus 3132Q-V Switches befinden sich 2 SFP+ Ports, die als 1/33 und 1/34 bezeichnet werden.
* Sie haben einige Ports an Nexus 3132Q-V Switches so konfiguriert, dass sie mit 10 GbE oder 40/100 GbE laufen.
+
[NOTE]
====
...
====
* Sie haben die Planung und Migration durchgeführt und die erforderliche Dokumentation zur 10-GbE- und 40/100-GbE-Konnektivität von Knoten zu Nexus 3132Q-V Cluster-Switches gelesen.
* Die in diesem Verfahren unterstützten ONTAP und NX-OS-Versionen sind hier aufgeführt:link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco Ethernet-Switches"^] Die


.Zu den verwendeten Beispielen
Die Beispiele in diesem Verfahren beschreiben den Austausch von Cisco Nexus 5596-Switches durch Cisco Nexus 3132Q-V-Switches.  Diese Schritte können Sie (mit Anpassungen) auch für andere ältere Cisco -Switches verwenden.
...
* Die Nexus 3132Q-V Switches, die die Nexus 5596 Switches ersetzen, sind *C1* und *C2*.
...
* Die Anzahl der 10-GbE- und 40/100-GbE-Ports ist in den Referenzkonfigurationsdateien (RCFs) definiert, die auf [Plattformname] verfügbar sind.link:https://mysupport.netapp.com/site/products/all/details/cisco-cluster-storage-switch/downloads-tab["Cisco Cluster-Netzwerk-Switch-Referenzkonfigurationsdatei herunterladen"^] Die
