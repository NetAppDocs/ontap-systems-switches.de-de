...
* Der zu ersetzende Cluster-Switch CL2 durch C2 (,Schritt 20 - ,33)
+
...
* Zwei FAS9000 Nodes wurden dem Cluster hinzugefügt, wobei Beispiele für Cluster-Details ( zeigen,Schritt 34 - ,37).
