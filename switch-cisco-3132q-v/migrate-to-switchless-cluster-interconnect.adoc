...
* link:https://kb.netapp.com/Support_Bulletins/Customer_Bulletins/SU540["SU540: Chelsio T6 NIC-Fehler verursachen Systemabschaltung beim Upgrade von 40G- auf 100G-Netzwerk-Switches"^]
* link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Node_panic_after_migration_from_switched_to_switchless_cluster["Knotenabsturz nach Migration von einem Cluster mit Switches zu einem Cluster ohne Switches"^]
