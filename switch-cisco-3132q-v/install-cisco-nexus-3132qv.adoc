...
.Was Sie benötigen
* Die anfänglichen Vorbereitungsanforderungen, Inhalt des Kits und Sicherheitsvorkehrungen im http://["Hardware-Installationsleitfaden Der Cisco Nexus 3000-Serie"^]. Lesen Sie diese Dokumente, bevor Sie mit dem Verfahren beginnen.
