...
summary: Sie können den Cisco Nexus 3132Q-V Switch und das Pass-Through-Panel mit den im Lieferumfang des Switches enthaltenen Standardhalterungen in einem NetApp -Schrank installieren. 
---
...
.Bevor Sie beginnen
* Die anfänglichen Vorbereitungsanforderungen, der Inhalt des Kits und die Sicherheitsvorkehrungen im http://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus3000/hw/installation/guide/b_n3000_hardware_install_guide.html["Hardware-Installationshandbuch für die Cisco Nexus 3000-Serie"^] Die  Lesen Sie diese Dokumente sorgfältig durch, bevor Sie mit dem Verfahren beginnen.
...
. Montieren Sie die Rack-Montagehalterungen am Nexus 3132Q-V Switch-Gehäuse.
+
...
+
Die beiden 3132Q-V-Switches werden immer in den oberen 2 HE des Schranks RU41 und 42 montiert.
...
+
image::../media/3132q_v_positioning.gif[3132Q-V Positionierung bei U39-40]
...
NOTE: Da der bereits installierte Schalter als Stütze dient, müssen Sie die Vorderseite des zweiten Schalters während des Installationsvorgangs nicht festhalten.
...
. Verbinden Sie den Management-Port jedes 3132Q-V-Switches mit einem der Management-Switches (falls bestellt) oder verbinden Sie diese direkt mit Ihrem Management-Netzwerk.
+
