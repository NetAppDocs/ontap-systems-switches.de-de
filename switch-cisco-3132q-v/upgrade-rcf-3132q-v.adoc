...
NOTE: Beim Upgrade oder der Anwendung eines neuen RCF müssen Sie die Schaltereinstellungen löschen und eine Grundkonfiguration durchführen.
...
+
Weitere Informationen zu Cisco-Befehlen finden Sie im entsprechenden Leitfaden in der https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 Serie NX-OS Befehlsreferenz"^].
...
NOTE: Anweisungen, wie Sie Ihre 10GbE-Ports nach einem Upgrade des RCF online bringen, finden Sie im Knowledge Base Artikel link:https://kb.netapp.com/onprem%2FSwitches%2FCisco%2F10GbE_ports_on_Cisco_3132Q_cluster_switch_do_not_come_online["Die 10GbE-Ports eines Cisco 3132Q Cluster-Switches werden nicht online geschaltet."^].
...
+
Weitere Informationen zu Cisco-Befehlen finden Sie im entsprechenden Leitfaden in der link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 Serie NX-OS Befehlsreferenz"^]. .Beispiel anzeigen
