...
summary: SSH ist für die Nutzung der Funktionen „Cluster Switch Health Monitor“ und „Protokollerfassung“ erforderlich. Um SSH auf Cisco 3132Q-V Cluster-Switches zu aktivieren, müssen Sie zunächst die SSH-Schlüssel generieren und anschließend SSH aktivieren. 
---
