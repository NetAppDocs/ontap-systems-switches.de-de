...
summary: Mit diesem Verfahren können Sie die NX-OS-Software auf dem Cluster-Switch Nexus 3132Q-V installieren. 
---
...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco Ethernet-Switch"^]. In der Switch-Kompatibilitätstabelle finden Sie die unterstützten ONTAP und NX-OS-Versionen.
...
. Kopieren Sie die NX-OS-Software mithilfe eines der folgenden Übertragungsprotokolle auf den Nexus 3132Q-V Switch: FTP, TFTP, SFTP oder SCP.  Weitere Informationen zu Cisco -Befehlen finden Sie im entsprechenden Leitfaden in https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 Serie NX-OS Befehlsreferenzhandbücher"^] Die
+
.Beispiel anzeigen
[%collapsible]
====
...
----
====
. Wiederholen Sie die Schritte 6 bis 11 auf Switch cs1.
...
.Wie geht es weiter?
Nach der Installation der NX-OS-Software können Sie link:install-upgrade-rcf-overview-3132q-v.html["Installieren oder aktualisieren Sie die Referenzkonfigurationsdatei (RCF)."]Die
