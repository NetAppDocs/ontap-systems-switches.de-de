...
----
====
. Kopieren Sie die NX-OS-Software mit einem der folgenden Übertragungsprotokolle auf den Nexus 3132Q-V-Switch: FTP, TFTP, SFTP oder SCP. Weitere Informationen zu Cisco-Befehlen finden Sie im entsprechenden Handbuch unter https://["Cisco Nexus 3000 Series NX-OS Command Reference Guides"^].
+
.Beispiel anzeigen
[%collapsible]
====
