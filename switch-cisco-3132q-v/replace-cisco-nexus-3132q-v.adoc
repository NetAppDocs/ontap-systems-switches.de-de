...
summary: 'Der Austausch eines defekten Cisco Nexus 3132Q-V Switches in einem Clusternetzwerk ist ein unterbrechungsfreies Verfahren (NDU), und Sie müssen eine bestimmte Abfolge von Aufgaben ausführen.' 
---
