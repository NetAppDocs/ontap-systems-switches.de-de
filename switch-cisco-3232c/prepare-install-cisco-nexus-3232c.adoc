...
summary: 'Die Cisco NX-OS Software und Referenzkonfigurationsdateien (RCFs) müssen auf Cisco Nexus 3232C Cluster-Switches installiert sein.' 
---
...
.Wie geht es weiter?
Nachdem Sie die Installation der NX-OS-Software und von RCF vorbereitet haben, können Sie link:install-nx-os-software-3232c.html["Installieren Sie die NX-OS-Software"]Die
