...
Die Beispiele in dieser Austauschprozedur verwenden vier Knoten. Zwei der Knoten nutzen vier 10-GB-Cluster-Interconnect-Ports: e0a, e0b, e0c und e0d. Die anderen beiden Knoten nutzen zwei 40-GB-Cluster-Interconnect-Ports: e4a und e4e. Siehe die link:https://hwu.netapp.com["Hardware Universe"^] zur Überprüfung der richtigen Cluster-Ports für Ihre Plattform.
