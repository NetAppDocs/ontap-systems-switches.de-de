...
* *I. Anzeigen und Migrieren physischer und logischer Ports (Schritte ,1-,10)*
* *II Fahren Sie die neu zugeordneten LIFs herunter und trennen Sie die Kabel (Schritte ,11-,14))*
* *III. Aktivieren Sie die Cluster-Ports (Schritte ,15-,20)*
* *IV. Aktivieren der neu zugewiesen LIFs (Schritte ,21-,33)*
