...
.Wie geht es weiter?
Nach der Installation der NX-OS-Software, link:install-upgrade-rcf-overview-3232c.html["Installieren oder aktualisieren Sie die Referenzkonfigurationsdatei (RCF)."]Die
