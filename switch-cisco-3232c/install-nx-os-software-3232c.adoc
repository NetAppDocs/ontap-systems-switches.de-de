...
summary: Mithilfe dieser Vorgehensweise können Sie die NX-OS-Software auf dem Nexus 3232C-Cluster-Switch installieren. 
---
...
. Kopieren Sie die NX-OS-Software und EPLD-Bilder auf den Nexus 3232C-Switch.
+
.Beispiel anzeigen
[%collapsible]
====
...
----
====
. Wenn Sie ein Upgrade auf NX-OS Version 9.3(11) durchführen, müssen Sie das EPPD-Image aktualisieren `golden` und den Switch erneut starten. fahren Sie andernfalls mit Schritt 12 fort.
+
Weitere Informationen finden Sie unter https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD Upgrade - Versionshinweise, Version 9.3(11)"^].
...
----
====
. Melden Sie sich nach dem Neustart des Switches an, um zu überprüfen, ob die neue EPLD-Version erfolgreich geladen wurde.
+
.Beispiel anzeigen
[%collapsible]
====
...
----
====
. Wiederholen Sie die Schritte 6 bis 14 am Schalter cs1.
