...
summary: Mit diesem Verfahren können Sie die NX-OS-Software auf dem Nexus 3232C Cluster-Switch installieren. 
---
...
[role="lead"]
Mit diesem Verfahren können Sie die NX-OS-Software auf dem Nexus 3232C Cluster-Switch installieren.
...
+
Weitere Einzelheiten finden Sie unter link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD-Upgrade-Versionshinweise, Version 9.3(11)"^].
...
.Wie geht es weiter?
Nach der Installation der NX-OS-Software können Sie link:install-upgrade-rcf-overview-3232c.html["Installieren oder aktualisieren Sie die Referenzkonfigurationsdatei (RCF)."]Die
