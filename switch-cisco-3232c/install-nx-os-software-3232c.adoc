...
----
====
. Melden Sie sich nach dem Neustart des Switches erneut an, aktualisieren Sie das goldene EPLD-Bild und starten Sie den Switch erneut.
+
.Beispiel anzeigen
[%collapsible]
====
...
link:install-rcf-3132q-v.html["Installieren Sie die RCF-Konfigurationsdatei"].
