...
* *Anzeige und Migration der Cluster-Ports auf Switch C2 (Schritte ,1-,7)*
* *ISL-Kabel vom Switch CL2 wieder an Switch C2 anschließen und ISLs auf Switch CL1 und C2 migrieren (Schritte ,8-,14)*
* *Zurücksetzen aller LIFs auf die ursprünglich zugewiesenen Ports (Schritte ,15-,18)*
* *Überprüfung, ob alle Ports und LIF korrekt migriert wurden (Schritte ,19-,21)*
