...
+
Wenn Sie die von NetApp unterstützte Version der Software herunterladen, müssen Sie auch die _NetApp Management Network Switch Reference Configuration File_ herunterladen und mit der zuvor gespeicherten Konfiguration zusammenführen. Sie können die Datei und Anweisungen von herunterladen https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco Ethernet-Switches"^] Seite.
