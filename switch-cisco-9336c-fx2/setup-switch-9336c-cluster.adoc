...
summary: Gehen Sie wie folgt vor, um den Cisco Nexus 9336C-FX2 Switch einzurichten und zu konfigurieren. 
---
...
Optional können Sie link:install-switch-and-passthrough-panel-9336c-cluster.html["Installation eines Cisco Nexus 9336C-FX2 Switch in einem NetApp Rack"]. Andernfalls fahren Sie mit fort link:install-nxos-overview-9336c-cluster.html["Bereiten Sie sich auf die Installation von NX-OS und RCF vor"].
