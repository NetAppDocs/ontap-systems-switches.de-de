...
Nachdem Sie Ihre Switches konfiguriert haben,link:install-nxos-overview-9336c-cluster.html["Bereiten Sie die Installation der NX-OS-Software und RCF vor"] .
