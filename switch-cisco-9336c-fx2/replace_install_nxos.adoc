...
[role="lead"]
Mithilfe dieses Verfahrens kann die NX-OS Software auf dem Nexus 9336C-FX2 Cluster Switch installiert werden.
...
----
. Überprüfen Sie nach dem Neustart des Switches die neue Version der NX-OS-Software: `show version`
+
[listing]
----
cs2# show version
