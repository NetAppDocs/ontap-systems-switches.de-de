...
** ISL-Ports aktiviert und verkabelt zwischen den NetApp CN1610-Switches und zwischen den neuen Switches.
...
----
====
. Fahren Sie auf Switch C2 die Ports herunter, die mit den Cluster-Ports der Knoten verbunden sind.
+
.Beispiel anzeigen
[%collapsible]
====
...
----
====
. Fahren Sie auf Switch C1 die Ports herunter, die mit den Cluster-Ports der Nodes verbunden sind.
+
.Beispiel anzeigen
[%collapsible]
====
