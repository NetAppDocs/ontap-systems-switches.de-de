...
Einzelheiten zu den unterstützten Ports und deren Konfigurationen finden Sie in der link:https://hwu.netapp.com/["Hardware Universe"^]. Weitere Informationen zu den Installationsvoraussetzungen für den Switch finden Sie in link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["Welche zusätzlichen Informationen benötige ich für die Installation meiner Geräte, die nicht in HWU enthalten sind?"^].
