...
.Wie geht es weiter?
Nachdem Sie die Installation der NX-OS-Software und von RCF vorbereitet haben, können Sie link:install-nxos-software-9336c-cluster.html["Installieren oder aktualisieren Sie die NX-OS-Software"]Die
