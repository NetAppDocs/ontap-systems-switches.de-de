...
Nachdem Sie die Installation der NX-OS-Software und RCF vorbereitet haben,link:install-nxos-software-9336c-cluster.html["Installieren oder aktualisieren Sie die NX-OS-Software"] .
