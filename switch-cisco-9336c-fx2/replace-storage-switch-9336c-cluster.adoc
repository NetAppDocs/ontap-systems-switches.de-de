...
* Sie müssen auf die entsprechenden Software- und Upgrade-Leitfäden verwiesen haben, die auf der Cisco Website verfügbar sind. Switches Der Cisco Nexus 3000-Serie
...
** Die anfängliche Konfiguration des Switches muss abgeschlossen sein.
