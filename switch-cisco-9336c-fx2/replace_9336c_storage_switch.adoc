...
[role="lead"]
Beim Austausch von Cisco Nexus 9336C-FX2 Storage-Switches müssen Sie bestimmte Konfigurationsinformationen, Portverbindungen und Verkabelungsanforderungen kennen.

.Bevor Sie beginnen
Vor der Installation der NX-OS-Software und der RCF auf einem Cisco Nexus 9336C-FX2-Storage-Switch müssen folgende Bedingungen erfüllt sein:
...
NOTE: Beachten Sie, dass es Abhängigkeiten zwischen der Befehlssyntax für in der RCF- und NX-OS-Version geben kann.

* Sie müssen die entsprechenden Software- und Upgrade-Leitfäden auf der Cisco-Website für vollständige Dokumentation zu den Upgrade- und Downgrade-Verfahren von Cisco für Switches nutzen. Switches Der Cisco Nexus 3000-Serie
...
+
Der Ersatz-Cisco Nexus 9336C-FX2-Switch muss die folgenden Eigenschaften aufweisen:
...
Dieses Verfahren ersetzt den zweiten Nexus 9336C-FX2 Storage Switch S2 durch den neuen 9336C-FX2 Switch NS2. Die beiden Knoten sind node1 und node2.
