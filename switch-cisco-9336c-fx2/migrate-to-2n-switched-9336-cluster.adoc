...
** Sehen https://hwu.netapp.com["Hardware Universe"^] für alle unterstützten ONTAP Versionen.
...
+
Sehen https://hwu.netapp.com["Hardware Universe"^] Weitere Informationen zur Verkabelung finden Sie hier.
...
Sehen https://hwu.netapp.com["Hardware Universe"^] Informationen zu den Cluster-Ports für Ihre Plattformen finden Sie hier. Sehen link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["Welche zusätzlichen Informationen benötige ich für die Installation meiner Geräte, die nicht in HWU enthalten sind?"^] Weitere Informationen zu den Installationsanforderungen des Schalters finden Sie hier.
...
+
https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe – Schalter"^]
