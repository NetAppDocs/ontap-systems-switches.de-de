...
** Siehe https://["Hardware Universe"^] Für alle unterstützten ONTAP-Versionen.
...
+
Siehe https://["Hardware Universe"^] Weitere Informationen zur Verkabelung.
...
+
https://["Hardware Universe – Switches"^]
