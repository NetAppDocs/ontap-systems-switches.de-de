...
.Wie geht es weiter?
Nach der Installation oder Aktualisierung der NX-OS-Software können Sielink:install-upgrade-rcf-overview-cluster.html["Installieren oder aktualisieren Sie die Referenzkonfigurationsdatei (RCF)."] Die
