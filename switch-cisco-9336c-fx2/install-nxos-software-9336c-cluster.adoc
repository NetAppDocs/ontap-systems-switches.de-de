...
[role="lead"]
Gehen Sie wie folgt vor, um die NX-OS-Software auf dem Nexus 9336C-FX2-Cluster-Switch zu installieren oder zu aktualisieren.
...
link:install-upgrade-rcf-overview-cluster.html["Referenzkonfigurationsdatei (RCF) installieren oder aktualisieren"]
