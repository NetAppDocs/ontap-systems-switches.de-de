...
* Für die anfänglichen Vorbereitungsanforderungen, den Kit-Inhalt und die Sicherheitsvorkehrungen beachten Sie bitte die link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Hardware-Installationshandbuch für die Cisco Nexus 9000-Serie"^].
...
.Wie geht es weiter?
Nachdem Sie die Switches im NetApp -Schrank installiert haben, können Sielink:setup-switch-9336c-cluster.html["Konfigurieren Sie die Cisco Nexus 9336C-FX2- und 9336C-FX2-T-Switches"] Die
