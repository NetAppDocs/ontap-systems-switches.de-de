...
---
= Installieren Sie NX-OS Software und RCFs auf Cisco Nexus 9336C-FX2 Cluster Switches
:allow-uri-read: 
...
* Sie müssen die Switch-Kompatibilitätstabelle auf dem konsultieren https://mysupport.netapp.com/site/info/cisco-ethernet-switch["_Cisco Ethernet Switch_"^] Seite für die unterstützten ONTAP-, NX-OS- und RCF-Versionen.
* Es können Befehlsabhängigkeiten zwischen der Befehlssyntax im RCF und denen in Versionen von NX-OS zu finden sind.
* Sie müssen die entsprechenden Software- und Upgrade-Leitfäden auf der Cisco Website für vollständige Dokumentation zu den Upgrade- und Downgrade-Verfahren von Cisco Switches auf *Switches der Cisco Nexus 9000-Serie* angegeben haben.
+
https://www.cisco.com/c/en/us/support/switches/nexus-9336c-fx2-switch/model.html#CommandReferences["Switches Der Cisco Nexus 9000-Serie"^]
...
Siehe https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe"] Um sicherzustellen, dass die korrekten Cluster-Ports auf Ihren Plattformen vorhanden sind.
...
. Ping für die Remote-Cluster-LIFs: `cluster ping-cluster -node node-name`
+
[listing]
----
...
----
. Vergewissern Sie sich, dass der automatische Zurücksetzen-Befehl auf allen Cluster-LIFs aktiviert ist: `network interface show -vserver Cluster -fields auto-revert`
+
[listing]
----
