...
* Sie verfügen über die richtige Anzahl und Art von Kabeln und Kabelverbindern für Ihre Switches. Siehe link:https://hwu.netapp.com["Hardware Universe"^].
...
Weitere Informationen zur Erstkonfiguration Ihres Switches finden Sie im folgenden link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9336c-fx2-e/cisco-nexus-9336c-fx2-e-nx-os-mode-switch-hardware-installation-guide.html["Cisco Nexus 9336C-FX2 Installations- und Upgrade-Leitfaden"^].
