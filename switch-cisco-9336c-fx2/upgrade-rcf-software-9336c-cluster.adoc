...
. Kopieren Sie die RCF auf den Bootflash auf Switch cs1 mithilfe eines der folgenden Übertragungsprotokolle: FTP, SFTP oder SCP.
+
...
+
Dieses Beispiel zeigt, wie SFTP verwendet wird, um eine RCF in den Bootflash auf dem Switch cs1 zu kopieren:
...
. Wenden Sie alle zuvor vorgenommenen Anpassungen auf die Switch-Konfiguration erneut an.  Siehelink:cabling-considerations-9336c-fx2.html["Überprüfung der Verkabelung und Konfigurationsüberlegungen"] Einzelheiten zu etwaigen weiteren erforderlichen Änderungen.
...
----
====
. Wiederholen Sie die Schritte 1 bis 19 auf Switch cs2.
. Automatische Wiederherstellung der Cluster-LIFs aktivieren.
+
`cluster1::*> *network interface modify -vserver Cluster -lif * -auto-revert True*`

. Führen Sie einen Neustart von Switch cs2 durch.
+
`cs2# *reload*`
...
CAUTION: Falls Ihr 9336C-FX2-Switch nach dem RCF-Upgrade nicht mehr startet, lesen Sie den NetApp Knowledge Base Artikel link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Cisco_9336C-FX2_Switch_Fails_to_Boot_After_RCF_Install_%E2%80%93_Boot_Variable_Cleared["Cisco 9336C-FX2 Switch startet nach RCF-Installation nicht – Boot-Variable gelöscht"^] für die nächsten Schritte.
