...
Optional können Sielink:install-switch-and-passthrough-panel-9336c-cluster.html["Installation eines Cisco Nexus 9336C-FX2 Switch in einem NetApp Rack"] .  Andernfalls gehen Sie zulink:cabling-considerations-9336c-fx2.html["Überprüfung der Verkabelung und Konfiguration"] .
