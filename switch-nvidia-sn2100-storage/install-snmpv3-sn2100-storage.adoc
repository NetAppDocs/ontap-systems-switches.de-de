...
summary: Diese Version beinhaltet Unterstützung für SNMPv3 zur Protokollüberwachung. 
---
...
[role="lead"]
Befolgen Sie dieses Verfahren, um SNMPv3 zu konfigurieren, das die Protokollerfassung von Switches und die Switch-Zustandsüberwachung (SHM) unterstützt.

.Informationen zu diesem Vorgang
Die folgenden Befehle konfigurieren einen SNMPv3-Benutzernamen auf NVIDIA SN2100-Switches:
...
Der folgende Befehl richtet den SNMPv3-Benutzernamen bei SHM ein:
...
----
====
. Konfigurieren Sie SHM für die Überwachung mit dem neuen SNMPv3-Benutzer:
+
...
----
====
. Überprüfen Sie nach Abschluss des SHM-Abfragezeitraums, ob die abzufragende Seriennummer des neu erstellten SNMPv3-Benutzers mit der im vorherigen Schritt angegebenen übereinstimmt.
+
