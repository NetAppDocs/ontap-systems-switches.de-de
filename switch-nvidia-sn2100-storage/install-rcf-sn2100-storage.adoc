...
summary: Gehen Sie wie folgt vor, um das RCF-Skript zu installieren. 
---
...
NOTE: Das folgende Beispielverfahren zeigt, wie das RCF-Skript für Cluster-Switches heruntergeladen und angewendet wird.


NOTE: Beispielausgabe des Befehls verwendet die Switch-Management-IP-Adresse 10.233.204.71, die Netzmaske 255.255.254.0 und das Standardgateway 10.233.204.1.
...
----
. Wenden Sie das RCF-Python-Skript *MSN2100-RCF-v1.8-Cluster* an:
+
[listing, subs="+quotes"]
----
...
. Wenden Sie alle zuvor vorgenommenen Anpassungen auf die Switch-Konfiguration erneut an.  Siehelink:cabling-considerations-sn2100-storage.html["Überprüfung der Verkabelung und Konfigurationsüberlegungen"] Einzelheiten zu etwaigen weiteren erforderlichen Änderungen.
...
.Wie geht es weiter?
Nach der Installation oder Aktualisierung des RCF können Sielink:setup-install-cshm-file.html["Installieren Sie die CSHM-Datei"] Die
