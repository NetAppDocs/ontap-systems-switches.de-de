...
Weitere Informationen zu den Verkabelungsrichtlinien finden Sie unter link:cabling-considerations-sn2100-storage.html["Überlegungen zu Verkabelung und Konfiguration"].
...
* Cumulus Linux (CL) OS Version 4.4.3. Aktuelle Kompatibilitätsinformationen finden Sie unter link:https://mysupport.netapp.com/site/info/nvidia-cluster-switch["NVIDIA Ethernet-Switches"^].
