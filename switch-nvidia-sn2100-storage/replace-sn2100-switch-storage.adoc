...
summary: 'Austausch eines defekten NVIDIA SN2100 Speicherschalters im Rahmen eines unterbrechungsfreien Verfahrens (NDU).' 
---
...
Die link:http://hwu.netapp.com["Hardware Universe"^] bietet vollständige Details zu den unterstützten Ports und deren Konfigurationen.
