...
NOTE: Beachten Sie link:cabling-considerations-sn2100-storage.html["Überlegungen zu Verkabelung und Konfiguration"] für Einschränkungen und weitere Details.
