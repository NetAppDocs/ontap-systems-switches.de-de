...
NOTE: Weitere Informationen zur Installation von Cumulus Linux finden Sie unter link:configure-software-sn2100-storage.html["Softwareinstallations-Workflow für NVIDIA SN2100-Switches"].
...
Weitere Details finden Sie in der NVIDIA https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/["Werksreset"^] Dokumentation.
