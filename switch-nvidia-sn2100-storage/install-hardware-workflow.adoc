...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Zwei"]link:cabling-considerations-sn2100-storage.html["Überprüfung der Verkabelung und Konfigurationsüberlegungen"]
[role="quick-margin-para"]
Überprüfen Sie die Anforderungen an optische Verbindungen, den QSA-Adapter und die Switchport-Geschwindigkeit.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["Drei"]link:install-cable-shelves-sn2100-storage.html["Verkabeln Sie die NS224-Regale"]
[role="quick-margin-para"]
