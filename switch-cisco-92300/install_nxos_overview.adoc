...
---
= Installieren Sie NX-OS Software und RCF auf Cisco Nexus 92300YC Cluster Switches
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die Cisco NX-OS-Software und die Referenzkonfigurationsdateien (RCFs) müssen auf Cisco Nexus 92300YC Cluster Switches installiert sein.
...
* Sie müssen die Switch-Kompatibilitätstabelle auf dem konsultieren https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco Ethernet Switch"^] Seite für die unterstützten ONTAP-, NX-OS- und RCF-Versionen.
* Es können Befehlsabhängigkeiten zwischen der Befehlssyntax im RCF und denen in Versionen von NX-OS zu finden sind.
* Sie müssen die entsprechenden Software- und Upgrade-Leitfäden auf der Cisco-Website für vollständige Dokumentation zu den Upgrade- und Downgrade-Verfahren auf dem von Cisco erhalten haben https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html#InstallandUpgrade["Switches Der Cisco Nexus 9000-Serie"^] Seite.
