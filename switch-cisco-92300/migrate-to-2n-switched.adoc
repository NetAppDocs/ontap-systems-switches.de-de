...
NOTE: Nach Abschluss der Migration müssen Sie möglicherweise die erforderliche Konfigurationsdatei installieren, um den Cluster Switch Health Monitor (CSHM) für 92300YC Cluster Switches zu unterstützen. Siehe link:../switch-cshm/cshm-overview.html["Switch-Zustandsüberwachung (CSHM)"].
...
+
Die link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe – Schalter"^] enthält weitere Informationen zur Verkabelung.
...
+
Die link:https://hwu.netapp.com["Hardware Universe"^] enthält die neuesten Informationen über die tatsächlichen Cluster-Ports für Ihre Plattformen.
...
----
====
. Automatische Wiederherstellung auf allen Cluster-LIFs deaktivieren:
+
