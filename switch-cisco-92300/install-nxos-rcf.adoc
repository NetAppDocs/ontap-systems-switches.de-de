...
* Die Beispiele in diesem Verfahren verwenden zwei Knoten. Diese Knoten verwenden zwei 10GbE-Cluster-Interconnect-Ports `e0a` und `e0b`. Siehe link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe"^], um die korrekten Cluster-Ports auf Ihren Plattformen zu überprüfen.
