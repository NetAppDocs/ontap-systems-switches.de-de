...
* Sie müssen die Switch-Kompatibilitätstabelle auf dem konsultieren https://["Cisco Ethernet Switch"^] Seite für die unterstützten ONTAP-, NX-OS- und RCF-Versionen.
