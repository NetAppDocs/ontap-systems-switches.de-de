...
summary: SSH ist für die Nutzung der Funktionen „Cluster Switch Health Monitor“ und „Protokollerfassung“ erforderlich. Um SSH auf Cisco 92300YC Cluster-Switches zu aktivieren, müssen Sie zunächst die SSH-Schlüssel generieren und anschließend SSH aktivieren. 
---
