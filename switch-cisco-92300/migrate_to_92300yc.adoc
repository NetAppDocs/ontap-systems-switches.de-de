...
---
= So migrieren Sie von einem Cisco Switch zu einem Cisco Nexus 92300YC Switch
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Die Nexus 92300YC Cluster Switches müssen konfiguriert und unter der korrekten Version der installierten NX-OS und der verwendeten Referenzkonfigurationsdatei (RCF) betrieben werden.
