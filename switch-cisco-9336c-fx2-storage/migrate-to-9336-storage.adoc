...
summary: Ältere Cisco Cluster-Switches für einen ONTAP Cluster können ohne Unterbrechung auf Cisco Nexus 9336C-FX2 Cluster-Netzwerk-Switches migriert werden. 
---
...
[role="lead"]
Sie können ältere Cisco -Switches für einen ONTAP Cluster auf Cisco Nexus 9336C-FX2- und 9336C-FX2-T-Speichernetzwerk-Switches migrieren. Dies ist ein unterbrechungsfreies Verfahren.
