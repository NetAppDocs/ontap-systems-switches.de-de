...
Optional können Sie link:install-switch-and-passthrough-panel-9336c-storage.html["Switch in NetApp-Schrank einbauen"]. Andernfalls fahren Sie mit fort link:install-nxos-overview-9336c-storage.html["Bereiten Sie sich auf die Installation von NX-OS und RCF vor"].
