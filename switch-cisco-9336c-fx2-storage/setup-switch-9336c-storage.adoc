...
Nachdem Sie Ihre Switches konfiguriert haben,link:install-nxos-overview-9336c-storage.html["Bereiten Sie die Installation der NX-OS-Software und RCF vor"] .
