...
[role="lead"]
Befolgen Sie dieses Verfahren, um die NX-OS Software auf den Nexus 9336C-FX2 und 9336C-FX2-T Switches zu installieren oder zu aktualisieren.
...
----
====
. Wenn Sie Ihren Switch zum ersten Mal einrichten, fahren Sie mit Schritt 14 fort. Wenn Sie Ihren Switch aktualisieren, fahren Sie mit dem nächsten Schritt fort.
