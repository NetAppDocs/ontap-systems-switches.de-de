...
Nachdem Sie die NX-OS-Software installiert oder aktualisiert haben,link:install-rcf-software-9336c-storage.html["Installieren oder aktualisieren Sie RCF"] .
