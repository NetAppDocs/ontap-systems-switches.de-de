...
summary: Wenn Sie bereits eine switchlose Clusterumgebung mit zwei Knoten besitzen, können Sie mithilfe von Cisco Nexus 9336C-FX2 Switches zu einer switchierten Clusterumgebung mit zwei Knoten migrieren, um die Anzahl der Knoten im Cluster auf über zwei zu erhöhen. 
---
...
[role="lead"]
Wenn Sie bereits eine _switchlose_ Clusterumgebung mit zwei Knoten besitzen, können Sie mithilfe von Cisco Nexus 9336C-FX2 Switches zu einer _switched_ Clusterumgebung mit zwei Knoten migrieren, um die Anzahl der Knoten im Cluster auf über zwei zu erhöhen.
...
* Sehen link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe – Schalter"^] Weitere Informationen zur Verkabelung finden Sie hier.
