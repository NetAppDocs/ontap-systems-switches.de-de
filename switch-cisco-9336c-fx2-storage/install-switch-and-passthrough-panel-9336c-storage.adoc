...
Nachdem Sie die Switches im NetApp Schrank installiert haben,link:setup-switch-9336c-storage.html["Konfigurieren Sie die Cisco Nexus 9336C-FX2- und 9336C-FX2-T-Switches"] .
