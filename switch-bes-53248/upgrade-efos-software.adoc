...
summary: Führen Sie diese Schritte aus, um die Ethernet Fabric OS EFOS Software auf dem BES-53248 Cluster-Switch zu aktualisieren. 
---
...
.Bevor Sie beginnen
* Laden Sie die passende Broadcom EFOS-Software für Ihre Cluster-Switches von der link:https://www.broadcom.com/support/bes-switch["Broadcom Ethernet-Switch-Unterstützung"^] Site herunter.
...
IMPORTANT: Beachten Sie, dass nach dem Upgrade von BES-53248 Cluster-Switches von EFOS 3.3.x.x oder 3.4.x.x auf EFOS 3.7.0.4 oder 3.8.0.2 die Inter-Switch-Links (ISLs) und Port-Channels als *Down* markiert werden. Dies ist das erwartete Verhalten und es ist sicher, mit dem Upgrade fortzufahren, sofern Sie keine Probleme mit automatisch zurücksetzenden LIFs haben. Weitere Einzelheiten finden Sie im Knowledge Base Artikel link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Systems/Fabric%2C_Interconnect_and_Management_Switches/BES-53248_Cluster_Switch_NDU_failed_upgrade_to_EFOS_3.7.0.4_and_later["BES-53248 Cluster Switch NDU konnte nicht auf EFOS 3.7.0.4 und höher aktualisiert werden."^].
