...
NOTE: Um einen Transaktionsschlüssel gegen eine Port-Lizenzschlüsseldatei einzulösen, siehe link:https://support.broadcom.com/web/csg/license-generation["Lizenzportal für Broadcom-unterstützte Ethernet-Switches"^]. Weitere Einzelheiten finden Sie im Knowledge Base Artikel link:https://kb.netapp.com/on-prem/Switches/Broadcom-KBs/How_to_add_Additional_Port_Licensing_for_the_Broadcom_BES_53248_Switch["So fügen Sie zusätzliche Portlizenzen für den Broadcom BES-53248 Switch hinzu"^].
