...
* Die Cluster-Ports auf jedem Knoten sind benannt `e0a` und `e0b`. Siehe link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] für die tatsächlich von Ihrer Plattform unterstützten Cluster-Ports.
