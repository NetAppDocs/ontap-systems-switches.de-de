...
+
Die link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] enthält Informationen zur ONTAP-Kompatibilität, unterstützten EFOS-Firmware und zur Verkabelung von BES-53248 Switches. Weitere Informationen zu den Installationsanforderungen für Switches finden Sie unter link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["Welche zusätzlichen Informationen benötige ich für die Installation meiner Geräte, die nicht in HWU enthalten sind?"^].
...
+
Die link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] enthält die neuesten Informationen über die tatsächlichen Cluster-Ports für Ihre Plattformen.
...
+
Die link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] enthält weitere Informationen zur Verkabelung.
