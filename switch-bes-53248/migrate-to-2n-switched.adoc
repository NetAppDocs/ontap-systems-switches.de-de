...
+
Der https://hwu.netapp.com/Home/Index["_NetApp Hardware Universe_"^] Enthält Informationen zur ONTAP Kompatibilität, zur unterstützten EFOS-Firmware und zur Verkabelung mit BES-53248-Switches.
...
--
====
. [[Schritt 9]]Ändern Sie die Berechtigungsstufe wieder auf Administrator:
+
`set -privilege admin`
