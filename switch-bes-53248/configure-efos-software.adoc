...
----
====
. Schließen Sie die Installation ab. Führen Sie diese vier Schritte aus, um den Switch neu zu konfigurieren:
+
...
----
====
. Schließen Sie die Installation ab. Der Switch startet ohne angewendete Konfiguration neu und wird auf die Werkseinstellungen zurückgesetzt. Befolgen Sie diese fünf Schritte, um den Switch neu zu konfigurieren:
+
