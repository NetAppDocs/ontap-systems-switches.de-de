...
Die link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] enthält Informationen zur ONTAP-Kompatibilität, zur unterstützten EFOS-Firmware und zur Verkabelung von BES-53248-Cluster-Switches. Weitere Informationen zu den Installationsvoraussetzungen der Switches finden Sie in link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["Welche zusätzlichen Informationen benötige ich für die Installation meiner Geräte, die nicht in HWU enthalten sind?"^].
