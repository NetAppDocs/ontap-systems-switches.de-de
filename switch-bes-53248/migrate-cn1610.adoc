...
Der https://["_NetApp Hardware Universe_"^] Enthält Informationen zur ONTAP-Kompatibilität, zu unterstützter EFOS-Firmware und zur Verkabelung mit BES-53248-Cluster-Switches.
...
+
Anschließend müssen Sie die getrennten Ports auf allen Nodes wieder an den neuen BES-53248-Switch cs2 anschließen. Siehe https://["_NetApp Hardware Universe_"^] Für genehmigte Kabeloptionen.
...
----
====
. Stellen Sie sicher, dass die ISLs auf dem CN1610 Switch CL1 „up“ sind:
+
`show port-channel`
...
+
Anschließend müssen Sie die getrennten Ports auf allen Nodes wieder an den neuen BES-53248-Switch cs1 anschließen. Siehe https://["_NetApp Hardware Universe_"^] Für genehmigte Kabeloptionen.
