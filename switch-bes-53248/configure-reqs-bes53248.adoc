...
Siehe die https://hwu.netapp.com/Switch/Index["NetApp Hardware Universe"^] Und https://mysupport.netapp.com/site/info/broadcom-cluster-switch["Broadcom-Switch-Kompatibilitätsmatrix"^] Informationen zur Kompatibilität von EFOS und ONTAP mit BES-53248-Switches finden Sie hier.  Die Unterstützung von EFOS und ONTAP kann je nach Maschinentyp des BES-53248-Switches variieren.  Einzelheiten zu allen Weichenmaschinentypen des Typs BES-52348 finden Sie unterlink:components-bes53248.html["Komponenten und Teilenummern für BES-53248 Cluster-Schalter"] Die
