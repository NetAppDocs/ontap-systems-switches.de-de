...
summary: 'SSH ist für die Nutzung des Cluster Switch Health Monitor (CSHM) und der Protokollerfassungsfunktionen erforderlich. Um SSH auf BES-53248 Cluster-Switches zu aktivieren, generieren Sie zunächst die SSH-Schlüssel und aktivieren dann SSH.' 
---
