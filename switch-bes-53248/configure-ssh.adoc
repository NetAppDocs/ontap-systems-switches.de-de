...
summary: SSH ist Voraussetzung für die Nutzung des Cluster Switch Health Monitor CSHM und der Protokollierungsfunktionen. Um SSH auf BES-53248 Cluster-Switches zu aktivieren, müssen Sie zunächst die SSH-Schlüssel generieren und anschließend SSH aktivieren. 
---
