...
+
Beachten Sie unbedingt die Kompatibilitätstabelle für Switches auf der http://["NetApp CN1601 und CN1610 Switches"^] Seite für die unterstützten FASTPATH und ONTAP Versionen.
