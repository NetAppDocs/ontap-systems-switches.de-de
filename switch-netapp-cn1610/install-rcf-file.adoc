...
summary: Bei der Installation einer Referenz-Konfigurationsdatei RCF müssen Sie zuerst die Cluster-LIFs vom Switch cs2 migrieren. Nach der Installation und Validierung der RCF können die LIFs wieder zurückmigriert werden. 
---
...
+
Der link:https://hwu.netapp.com/["Hardware Universe"^] enthält weitere Informationen über die tatsächlich auf Ihrer Plattform unterstützten Cluster-Ports.
