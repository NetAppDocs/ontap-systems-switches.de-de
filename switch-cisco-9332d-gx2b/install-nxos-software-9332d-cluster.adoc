...
.Wie geht es weiter?
Nach der Installation oder Aktualisierung der NX-OS-Software können Sie link:install-upgrade-rcf-overview-cluster-9332d.html["Installieren oder aktualisieren Sie die Referenzkonfigurationsdatei (RCF)."].
