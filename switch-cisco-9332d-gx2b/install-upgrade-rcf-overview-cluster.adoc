...
[role="lead"]
Sie installieren die Referenz-Konfigurationsdatei (RCF), nachdem Sie den Nexus 9332D-GX2B Switch zum ersten Mal eingerichtet haben. Sie aktualisieren Ihre RCF-Version, wenn bereits eine Version der RCF-Datei auf Ihrem Switch installiert ist.
...
Siehe  https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe"^], um die korrekten Ports auf Ihrer Plattform zu überprüfen.
