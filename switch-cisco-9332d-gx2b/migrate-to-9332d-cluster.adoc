...
NOTE: Warten Sie einige Sekunden, bevor Sie den `show` Befehl, um die Details anzuzeigen.
...
Nachdem Sie die Switches migriert haben,link:../switch-cshm/config-overview.html["Konfigurieren der Switch-Integritätsüberwachung"] .
