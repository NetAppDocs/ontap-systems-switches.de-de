...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Vier"]link:install-upgrade-rcf-overview-cluster-9332d.html["Installieren oder aktualisieren Sie die RCF"]
[role="quick-margin-para"]
