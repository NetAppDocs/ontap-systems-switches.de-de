...
summary: 'Der Austausch eines defekten Nexus 9332D-GX2B Switches in einem Clusternetzwerk ist ein unterbrechungsfreies Verfahren (NDU).' 
---
...
* Lösen Sie vor und nach der Wartung eine AutoSupport-Wartungsmeldung aus, um die Fallerstellung für die Dauer der Wartung zu deaktivieren. Weitere Informationen finden Sie in diesem Knowledge Base Artikel https://kb.netapp.com/Support_Bulletins/Customer_Bulletins/SU92["SU92: Wie man die automatische Fallerstellung während geplanter Wartungsfenster unterdrückt"^].
...
----
====
. Aktivieren Sie alle Ports, Eth1/1 bis Eth1/30, auf dem Switch newcs2.
+
.Beispiel anzeigen
[%collapsible]
====
