...
summary: SSH ist für die Nutzung der Funktionen „Cluster Switch Health Monitor“ und „Protokollerfassung“ erforderlich. Um SSH auf Cisco 9332d-gx2b Cluster-Switches zu aktivieren, generieren Sie zuerst die SSH-Schlüssel und aktivieren dann SSH. 
---
