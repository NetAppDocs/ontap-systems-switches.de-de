...
summary: Setzen Sie den 9332D-GX2B-Switch auf die Werkseinstellungen zurück. 
---
= Setzen Sie den 9332D-GX2B-Switch auf die Werkseinstellungen zurück
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Um den 9332D-GX2B-Switch auf die Werkseinstellungen zurückzusetzen, müssen Sie die 9332D-GX2B-Switch-Einstellungen löschen.
