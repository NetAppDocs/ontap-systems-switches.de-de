...
.. Für NX-OS 10.2 und höher verwenden Sie die `show diff running-config` Befehl zum Vergleichen mit der gespeicherten RCF-Datei im Bootflash.  Verwenden Sie andernfalls ein Vergleichstool eines Drittanbieters.
...
----
====
. Wiederholen Sie die Schritte 4 bis 17 auf Switch cs2.
