...
Nachdem Sie die Installation der NX-OS-Software und RCF vorbereitet haben,link:install-nxos-software-9332d-cluster.html["Installieren oder aktualisieren Sie die NX-OS-Software"] .
