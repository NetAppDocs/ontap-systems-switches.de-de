...
summary: 'Die Cisco NX-OS-Software und Referenzkonfigurationsdateien (RCFs) müssen auf Cisco Nexus 9332D-GX2B-Cluster-Switches installiert werden.' 
---
...
+
** node1-01_clus1 und node1-01_clus2 für node1-01
** node1-02_clus1 und node1-02_clus2 für node1-02
** node1-03_clus1 und node1-03_clus2 für node1-03
** node1-04_clus1 und node1-04_clus2 für node1-04
...
.. *Cluster-Ports*
+
... Zeigen Sie an, wie viele Cluster-Interconnect-Schnittstellen in jedem Knoten für jeden Switch konfiguriert sind:
+
[source, cli]
----
...
----
====
... Informationen zu den Cluster-LIFs anzeigen:
+
[source, cli]
----
...
.. *HA-Ports*
+
... Informationen zu den HA-Ports anzeigen:
+
...
.. *Speicheranschlüsse*
+
... Informationen zu den Speicherports anzeigen:
+
[source, cli]
----
...
. Stellen Sie sicher, dass der Befehl zum automatischen Zurücksetzen auf allen Cluster-LIFs aktiviert ist:
+
[source, cli]
----
...
.Wie geht es weiter?
Nachdem Sie die Installation der NX-OS-Software und von RCF vorbereitet haben, link:install-nxos-software-9332d-cluster.html["Installieren oder aktualisieren Sie die NX-OS-Software"]Die
