...
NOTE: Während `scp` Wird in dem Beispiel verwendet, können Sie Ihre bevorzugte Methode der Dateiübertragung verwenden.
...
NOTE: Obwohl `scp` in diesem Beispiel verwendet wird, können Sie Ihre bevorzugte Methode der Dateiübertragung verwenden.
