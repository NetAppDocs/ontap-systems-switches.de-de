...
* Cumulus Linux ist installiert. Siehe https://["Hardware Universe"^] Für unterstützte Versionen.
* IP-Adresse, Subnetzmaske und Standard-Gateway über DHCP oder manuell konfiguriert definiert.


.Aktuelle RCF-Skriptversionen
Für Cluster- und Speicheranwendungen stehen zwei RCF-Skripte zur Verfügung. Laden Sie RCFs von herunter https://["Hier"^]. Das Verfahren für jedes ist gleich.
...
NOTE: Für Probleme mit RCF-Python-Skripts, die nicht behoben werden können, wenden Sie sich an https://["NetApp Support"^] Für weitere Unterstützung.
