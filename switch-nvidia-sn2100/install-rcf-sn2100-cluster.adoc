...
Für Cluster- und Speicheranwendungen stehen zwei RCF-Skripte zur Verfügung. Laden Sie RCFs von herunter https://mysupport.netapp.com/site/info/nvidia-cluster-switch["Hier"^]. Das Verfahren für jedes ist gleich.
