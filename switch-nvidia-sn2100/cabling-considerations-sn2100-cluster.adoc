...
--
====
Weitere Einzelheiten finden Sie im Knowledge Base Artikel link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Systems/Fabric_Interconnect_and_Management_Switches/NVIDIA_SN2100_switch_fails_to_connect_using_40_100GbE_copper_cable["Der SN2100-Switch kann keine Verbindung über 40/100GbE-Kupferkabel herstellen."^].
