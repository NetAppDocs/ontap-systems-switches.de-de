...
summary: Führen Sie die folgenden Schritte aus, um Ihre Cumulus Linux-Version zu aktualisieren. 
---
...
NOTE: Bei jedem Upgrade von Cumulus Linux wird die gesamte Dateisystemstruktur gelöscht und neu aufgebaut.  Ihre bestehende Konfiguration wird gelöscht.  Sie müssen Ihre Switch-Konfiguration speichern und protokollieren, bevor Sie Cumulus Linux aktualisieren.
...
Weitere Informationen finden Sie unter link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-510/Installation-Management/Installing-a-New-Cumulus-Linux-Image/["Installation eines neuen Cumulus Linux-Images"^].
...
----
+
Weitere Informationen finden Sie in der link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-54/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["NVIDIA Benutzerkonten"^].
...
====
.Wie geht es weiter?
Nach dem Upgrade Ihrer Cumulus Linux-Version können Sielink:install-rcf-sn2100-cluster.html["Installieren oder aktualisieren Sie das RCF-Skript"] Die
