...
summary: Der NVIDIA SN2100 Switch ist ein 10/25/40/100 GbE Ethernet-Switch, auf dem Cumulus Linux läuft.  Der SN2100-Switch dient Cluster- und Speicheranwendungen in ONTAP 9.10.1 über verschiedene Switch-Paare. 
---
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["Drei"]link:required-documentation-sn2100-cluster.html["Überprüfen Sie die erforderlichen Unterlagen"]
[role="quick-margin-para"]
