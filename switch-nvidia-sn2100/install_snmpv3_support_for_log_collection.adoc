...
[role="lead"]
Diese Version umfasst Unterstützung für SNMPv3 für die Erfassung von Switch-Protokollen für Switch Health Monitoring (SHM).
...
.Schritte
. Richten Sie den SNMPv3-Benutzer auf dem Switch ein, um Authentifizierung und Verschlüsselung zu verwenden:
+
[listing, subs="+quotes"]
----
