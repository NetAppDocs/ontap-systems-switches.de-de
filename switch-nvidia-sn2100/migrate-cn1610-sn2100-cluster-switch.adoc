...
summary: Sie können NetApp CN1610 Cluster-Switches für einen ONTAP Cluster unterbrechungsfrei auf NVIDIA SN2100 Cluster-Netzwerk-Switches migrieren. 
---
...
Sie müssen sich bestimmter Konfigurationsinformationen, Portverbindungen und Verkabelungsanforderungen bewusst sein, wenn Sie NetApp CN1610 Cluster-Switches durch NVIDIA SN2100 Cluster-Switches ersetzen. Siehe link:configure-overview-sn2100-cluster.html["Übersicht über Installation und Konfiguration von NVIDIA SN2100-Switches"].
