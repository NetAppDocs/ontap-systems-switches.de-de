...
NOTE: Cumulus Linux (CL) OS kann entweder installiert werden, wenn auf dem Switch Cumulus Linux oder ONIE läuft (siehelink:install-onie-mode-sn2100-cluster.html["Installation im ONIE-Modus"] ).
