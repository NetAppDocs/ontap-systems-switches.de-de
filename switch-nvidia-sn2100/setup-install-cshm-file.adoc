...
summary: Mit diesem Verfahren können Sie die entsprechende Konfigurationsdatei für die Zustandsüberwachung von NVIDIA SN2100 Cluster-Switches installieren. 
---
...
NOTE: Falls Ihr Modell nach Anwendung der Konfigurationsdatei immer noch *ANDERE* anzeigt, wenden Sie sich bitte an den NetApp -Support.
