...
Nachdem Sie Cumulus Linux im ONIE-Modus installiert haben, link:install-rcf-sn2100-cluster.html["Installieren Sie das Skript der Referenzkonfigurationsdatei (RCF)."]Die
