...
Einzelheiten zu den unterstützten Ports und deren Konfigurationen finden Sie in der link:https://hwu.netapp.com/["Hardware Universe"^].
...
NOTE: Wenn Sie die Portgeschwindigkeit der Cluster-Ports e0a und e1a auf AFF A800 oder AFF C800 Systemen ändern, kann es nach der Geschwindigkeitsumstellung zu fehlerhaften Paketen kommen. Siehe link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/BURT/1570339["Bug 1570339"^] und den Knowledge Base Artikel link:https://kb.netapp.com/onprem/ontap/hardware/CRC_errors_on_T6_ports_after_converting_from_40GbE_to_100GbE["CRC-Fehler an T6-Ports nach der Umstellung von 40GbE auf 100GbE"^] für Anleitungen.
