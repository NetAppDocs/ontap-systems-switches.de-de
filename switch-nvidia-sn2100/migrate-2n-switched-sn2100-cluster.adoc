...
IMPORTANT: Siehe link:cabling-considerations-sn2100-cluster.html["Überprüfung der Verkabelung und Konfigurationsüberlegungen"] für Hinweise und weitere Details. Die link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe – Schalter"^] enthält auch weitere Informationen zur Verkabelung.
