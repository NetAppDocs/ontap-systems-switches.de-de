...
IMPORTANT: Siehe link:cabling-considerations-sn2100-cluster.html["Prüfen Sie die Verkabelung und Konfigurationsüberlegungen"] Bei Einschränkungen und weiteren Details. Der https://["Hardware Universe – Switches"^] Enthält auch weitere Informationen über Verkabelung.
