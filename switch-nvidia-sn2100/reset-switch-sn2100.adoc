...
NOTE: Weitere Informationen zur Installation von Cumulus Linux finden Sie unterlink:configure-software-overview-sn2100-cluster.html["Softwareinstallations-Workflow für NVIDIA SN2100-Switches"] Die
...
Siehe NVIDIA https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/["Werksreset"^] Weitere Einzelheiten finden Sie in der Dokumentation.
