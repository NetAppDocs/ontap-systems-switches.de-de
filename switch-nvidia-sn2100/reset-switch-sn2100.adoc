...
NOTE: Weitere Informationen zur Installation von Cumulus Linux finden Sie unter link:configure-software-overview-sn2100-cluster.html["Softwareinstallations-Workflow für NVIDIA SN2100-Switches"].
...
--
. Laden Sie über die Cumulus-Konsole die Installation der Switch-Software mit dem Befehl herunter und stellen Sie sie in die Warteschlange. `onie-install -a -i` gefolgt vom Dateipfad zur Switch-Software, zum Beispiel:
+
[listing, subs="+quotes"]
----
...
NOTE: Der Switch startet neu und beginnt mit der Installation der Switch-Software, was einige Zeit in Anspruch nimmt. Nach Abschluss der Installation startet der Switch neu und verbleibt im aktuellen Zustand. `log-in` prompt.
...
Weitere Einzelheiten entnehmen Sie bitte der NVIDIA link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/Installation-Management/Factory-Reset/["Werksreset"^] Dokumentation.

--
====
.Was kommt als nächstes
Nachdem Sie Ihre Schalter zurückgesetzt haben, können Sielink:configure-overview-sn2100-cluster.html["neu konfigurieren"] sie nach Bedarf.
