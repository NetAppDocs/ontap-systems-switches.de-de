...
---
= Aktualisieren Sie das RCF-Skript (Reference Configuration File)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Gehen Sie wie folgt vor, um das RCF-Skript zu aktualisieren.

.Was Sie benötigen
Stellen Sie vor dem Upgrade des RCF-Skripts sicher, dass auf dem Switch folgende Optionen verfügbar sind:
