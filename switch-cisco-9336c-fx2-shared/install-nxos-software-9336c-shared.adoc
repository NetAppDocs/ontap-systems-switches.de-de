...
[role="lead"]
Gehen Sie wie folgt vor, um die NX-OS-Software auf dem gemeinsam genutzten Switch Nexus 9336C-FX2 zu installieren.
...
.Wie geht es weiter?
Nach der Installation der NX-OS-Software können Sie link:install-nxos-rcf-9336c-shared.html["Installieren Sie den RCF"]Die
