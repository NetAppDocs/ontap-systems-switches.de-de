...
---
= Installieren Sie einen Cisco Nexus 9336C-FX2 Switch in einem NetApp Schrank
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Je nach Konfiguration müssen Sie möglicherweise den Cisco Nexus 9336C-FX2 Switch und das Pass-Through-Panel in einem NetApp -Schrank installieren. Standardhalterungen sind im Lieferumfang des Schalters enthalten.
