...
----
====
. Überprüfen Sie den administrativen und operativen Status jedes Cluster-Ports, Knotenspeicher-Ports und Speicherregal-Ports.
+
...
CAUTION: Stellen Sie sicher, dass Sie *alle* verbundenen Cluster-Ports herunterfahren, um Netzwerkverbindungsprobleme zu vermeiden. Siehe Knowledge Base Artikel link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Node_out_of_quorum_when_migrating_cluster_lif_during_switch_OS_upgrade["Knoten außerhalb des Quorums bei Migration des Cluster-LIF während des Switch-OS-Upgrades"^] für weitere Details.
...
. Weitere Einzelheiten zu eventuell erforderlichen Änderungen finden Sie unter link:cabling-considerations-9336c-shared.html["Überprüfung der Verkabelung und Konfigurationsüberlegungen"].
...
. Überprüfen Sie die Integrität aller Ports im Cluster.
+
...
----
====
. Wiederholen Sie die Schritte 1 bis 21 auf Switch cs2.
