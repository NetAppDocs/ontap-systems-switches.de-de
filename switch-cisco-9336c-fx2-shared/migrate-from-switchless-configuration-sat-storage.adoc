...
. [[step7]]Ersetzen Sie die Speicher-RCF auf Shared Switch A durch die gemeinsam genutzte RCF-Datei. Siehe link:install-nxos-rcf-9336c-shared.html["Installieren Sie das RCF auf einem gemeinsamen Cisco Nexus 9336C-FX2 Switch"] Entnehmen.
...
. [[step 13]]Ersetzen Sie die Speicher-RCF-Datei auf Shared Switch B durch die gemeinsam genutzte RCF-Datei. Siehe link:install-nxos-rcf-9336c-shared.html["Installieren Sie das RCF auf einem gemeinsamen Cisco Nexus 9336C-FX2 Switch"] Entnehmen.
. Überprüfen Sie, ob der mit HA-Paar 1 verbundene Storage-Switch B in einem ordnungsgemäßen Zustand ist:
+
`system health alert show -instance`
